...
import '/components/url_api_widget.dart';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    const Color(0xFFF48222),
                    const Color(0xFFFAA753),
              ...
              child: Padding(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final signInLoginResponse = snapshot.data!;
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiLogin = await LoginCall.call(
                                  login: _model.emailController.text,
                                ...
                                if (LoginCall.statusLogin(
                                  ...
                                  setState(() {
                                    ...
                                    FFAppState().NomeUsuario =
                                        LoginCall.usuarioLogin(
                                      (_model.apiLogin?.jsonBody ?? ''),
                                    )!;
                                    FFAppState().dataDoUltimoLogin =
                                        getCurrentTimestamp;
                                    FFAppState().senhaSenha =
                                        _model.senhaController.text;
                                  });
